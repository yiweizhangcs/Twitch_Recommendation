...
import com.loffer.jupiter.entity.db.ItemType;
...
import com.loffer.jupiter.entity.response.Game;

import java.util.*;

@Service
public class GameService {
    private static final String TOKEN = "Bearer pjqk8eps1tq30c6ub9elbw5rwca55w";
    private static final String CLIENT_ID = "pbcdv7ozkdlqsik7dpkxvtzhw9fr47";
